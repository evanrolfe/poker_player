...
public class Hand {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String holeCards = "7h9h";
        String boardCards = "8h6c4h";

        double hs = handStrength(holeCards, boardCards);
        double[] hp = handPotential(holeCards, boardCards, 2);
        ...
        System.out.println("Positive potential: "+hp[POSITIVE]);
        System.out.println("Negative potential: "+hp[NEGATIVE]);
        System.out.println("Completed in: "+diff+"s");
        ...
        hs = handStrength(holeCards, boardCards);
        hp = handPotential(holeCards, boardCards, 1);
